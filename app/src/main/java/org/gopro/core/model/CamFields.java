    ...
    implements Serializable
{
    ...
    public CamFields()
    {
        ...
        mode = 0;
        submode = 0;
        timelapsevideointerval = 0;
        nightlapseinterval = 0;
        nightlapseshutter = 0;
        videophotointerval = 0;
        continousphotorate = 0;
        photoshutter = 0;
        ondefault = 0;
        videoexposure = 0;
        photoexposure = 0;
        ...
        photoResolution = 0;
        burstResolution = 0;
        protuneVideoSetting = 0;
        protunePhotoSetting = 0;
        protuneBurstSetting = 0;
        previewValid = 0;
        playbacksec = 0;
        playbackmin = 0;
        mFieldOfView = 0;
        ...
        mLocateActive = false;
        mCameraBusy = false;
        mProtuneVideoEnabled = -1;
        mProtunePhotoEnabled = -1;
        mProtuneBurstEnabled = -1;
    ...
    public int getPhotoExposure()
    {
        return photoexposure;
    }

    public int getBurstExposure()
    {
        return burstexposure;
    }
    ...
    public int getNightlapseInterval()
    {
    	return nightlapseinterval;
    }

    public int getNightlapseShutter()
    {
    	return nightlapseshutter;
    }

    public int getVideoPhotoInterval ()
    {
    	return videophotointerval;
    }

    public int getContinousPhotoRate ()
    {
    	return continousphotorate;
    }
    
    public int getPhotoShutter ()
    {
    	return photoshutter;
    }
    ...
    public String getPlaybackStart() { return playbackstart; }
    ...
    public int getProtuneVideoEnabled()
    {
        return mProtuneVideoEnabled;
    }

    public int getProtunePhotoEnabled()
    {
        return mProtunePhotoEnabled;
    }

    public int getProtuneBurstEnabled()
    {
        return mProtuneBurstEnabled;
    }

    public int getProtuneVideoSetting()
    {
        return protuneVideoSetting;
    }

    public int getProtunePhotoSetting()
    {
        return protunePhotoSetting;
    }

    public int getProtuneBurstSetting()
    {
        return protuneBurstSetting;
    }
    ...
    {
        return Boolean.valueOf(lowlight);
    }
    ...
    public int getNoSDCard() { return mNoSDCard; }
    ...
    public int isProtuneVideoEnabled()
    {
        return mProtuneVideoEnabled;
    }

    public int isProtunePhotoEnabled()
    {
        return mProtunePhotoEnabled;
    }

    public int isProtuneBurstEnabled()
    {
        return mProtuneBurstEnabled;
    }
    ...
    public void setVideoExposure(int i)
    {
        videoexposure = i;
    }
    
    public void setPhotoExposure(int i)
    {
        photoexposure = i;
    }
    
    public void setBurstExposure(int i)
    {
        burstexposure = i;
    }
    ...
    {
    	timelapsevideointerval = i;
    }

    public void setNightlapseInterval(int i)
    {
    	nightlapseinterval = i;
    }

    public void setNightlapseShutter(int i)
    {
    	nightlapseshutter = i;
    }

    public void setVideoPhotoInterval (int i)
    {
    	videophotointerval = i;
    }

    public void setContinousPhotoRate (int i)
    {
    	continousphotorate = i;
    }
    
    public void setPhotoShutter (int i)
    {
    	photoshutter = i;
    }
    ...
    public void setBurstResolution(int i)
    {
        burstResolution = i;
    }
    ...
    public void setProtuneVideoEnabled(short s)
    {
        mProtuneVideoEnabled = s;
    }

    public void setProtunePhotoEnabled(short s)
    {
        mProtunePhotoEnabled = s;
    }

    public void setProtuneBurstEnabled(short s)
    {
        mProtuneBurstEnabled = s;
    }

    public void setProtuneVideoSetting(int i)
    {
        protuneVideoSetting = i;
    }

    public void setProtunePhotoSetting(int i)
    {
        protunePhotoSetting = i;
    }

    public void setProtuneBurstSetting(int i)
    {
        protuneBurstSetting = i;
    }
    ...
    public void setLowLight(Boolean boolean1)
    {
        lowlight = boolean1.booleanValue();
    }
    ...
    private int mProtuneVideoEnabled;
    private int mProtunePhotoEnabled;
    private int mProtuneBurstEnabled;
    ...
    private int mNoSDCard;
    private int majorversion;
    private int microphone;
    private int minorversion;
    private int mode;
    private int submode;
    private int timelapsevideointerval;
    private int nightlapseinterval;
    private int nightlapseshutter;
    private int videophotointerval;
    private int continousphotorate;
    ...
    private int protuneVideoSetting;
    private int protunePhotoSetting;
    private int protuneBurstSetting;
    private int shutter;
